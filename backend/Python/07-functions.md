...
- [3. Personnaliser le comportement d'une fonction](#3-personnaliser-le-comportement-dune-fonction)
---
...
## 3-Personnaliser le comportement d'une fonction
[À venir : paramètres, arguments, valeurs de retour...]